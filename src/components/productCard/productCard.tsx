...
export const ProductCardPage = ({ productCard, onBack }: { productCard: Product; onBack: (product: Product) => void }) => {
    return (
                ...
                <div className="flex flex-col items-center md:items-start gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        <h3 className="text-gray-300">
                            <span className=' text-blue-500 '>{productCard?.packaging.slice(0, 2)}</span>
                            {productCard?.packaging.slice(2)}
                        </h3>
